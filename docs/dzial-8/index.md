...
**6 godzin · 5 tematów · klasa 3TT · kwalifikacja INF.07**
...
<div class="kp-podsumowanie" data-karta="dzial-8"></div>

<span id="karta" class="kp-kotwica"></span>

??? karta "Rozwiń kartę pracy działu VIII"
    ...
    !!! warning "Chcesz dokończyć w domu — zapisz postęp do pliku"
        ...
        Dostaniesz plik `postep_asso-dzial-8.json` — przenieś go
