...
- poprawiać można oceny z prac obejmujących **cały dział** (praktyczny sprawdzian wiadomości kończący dział); kartkówki,
...
??? abstract "Dział I. Organizacja pracy, sieciowe systemy operacyjne i wirtualizacja — 3 godziny"
...
??? abstract "Dział II. Wdrożenie serwera Linux i podstawy administracji — 7 godzin"
...
??? abstract "Dział III. Konfiguracja sieciowa serwera — 6 godzin"
...
??? abstract "Dział IV. Wdrażanie ról i usług sieciowych: DHCP i DNS — 7 godzin"
...
??? abstract "Dział V. Udostępnianie zasobów w sieci komputerowej — 7 godzin"
...
??? abstract "Dział VI. Usługi internetowe i pocztowe — 6 godzin"

    **Ocena dopuszczająca (2)** — *wymagania konieczne*

    - wymienia usługi internetowe udostępniane przez serwer
    - z pomocą nauczyciela instaluje serwer WWW
    - otwiera stronę serwowaną przez serwer z poziomu stacji klienckiej

    **Ocena dostateczna (3)** — *wymagania podstawowe*

    - instaluje serwer Apache i publikuje stronę pod adresem IP serwera
    ...
    **Ocena dobra (4)** — *wymagania rozszerzające*
    ...
    - konfiguruje host wirtualny i publikuje kilka witryn na jednym serwerze
    ...
    **Ocena bardzo dobra (5)** — *wymagania dopełniające*
    ...
    - dokonuje rekonfiguracji usług WWW i FTP dla zadanych wymagań i sprawdza skutek zmiany
    ...
    **Ocena celująca (6)** — *wymagania wykraczające*
    ...
    - wdraża witrynę wraz z osobną witryną FTP do jej aktualizacji i dokumentuje konfigurację
    - rozwiązuje zadania egzaminacyjne INF.07 dotyczące usług internetowych

??? abstract "Dział VII. Zdalna administracja i monitorowanie — 5 godzin"
...
??? abstract "Dział VIII. Zabezpieczanie sieciowego systemu operacyjnego — 6 godzin"

    **Ocena dopuszczająca (2)** — *wymagania konieczne*

    - wymienia znane zagrożenia dla serwera pracującego w sieci
    - sprawdza, czy zapora jest włączona
    - wyjaśnia, czym jest szkodliwe oprogramowanie

    **Ocena dostateczna (3)** — *wymagania podstawowe*

    - określa metody ataków sieciowych
    ...
    **Ocena dobra (4)** — *wymagania rozszerzające*
    ...
    - konfiguruje zaporę sieciową dla serwera udostępniającego kilka usług
    ...
    **Ocena bardzo dobra (5)** — *wymagania dopełniające*
    ...
    - projektuje zestaw reguł zapory dla zadanego zestawu usług i sprawdza ich skutki, korygując regułę blokującą potrzebny ruch
    ...
    **Ocena celująca (6)** — *wymagania wykraczające*
    ...
    - opracowuje procedurę zabezpieczenia świeżo wdrożonego serwera i sprawdza jej skuteczność
    - rozwiązuje zadania egzaminacyjne INF.07 dotyczące zabezpieczania systemów sieciowych

??? abstract "Dział IX. Kopie bezpieczeństwa, diagnostyka i usuwanie awarii — 6 godzin"

    **Ocena dopuszczająca (2)** — *wymagania konieczne*

    - wyjaśnia, czym jest kopia bezpieczeństwa
    - wymienia typowe objawy awarii serwera i usługi sieciowej
    - wskazuje narzędzia służące do diagnozowania systemu

    **Ocena dostateczna (3)** — *wymagania podstawowe*

    - charakteryzuje typy kopii bezpieczeństwa: pełną, przyrostową i różnicową
    ...
    **Ocena dobra (4)** — *wymagania rozszerzające*
    ...
    - opisuje strategie tworzenia kopii bezpieczeństwa i porównuje je pod względem czasu odtwarzania
    ...
    **Ocena bardzo dobra (5)** — *wymagania dopełniające*
    ...
    - dobiera typ kopii bezpieczeństwa i strategię ich tworzenia do określonych warunków, uzasadniając wybór
    ...
    **Ocena celująca (6)** — *wymagania wykraczające*
    ...
    - przeprowadza analizę zadanej awarii i przedstawia pełną dokumentację z jej usunięcia
    - rozwiązuje zadania egzaminacyjne INF.07 dotyczące diagnostyki i ochrony danych

??? abstract "Dział X. Współpraca systemów Linux i Windows w jednej sieci — 4 godziny"

    **Ocena dopuszczająca (2)** — *wymagania konieczne*

    - wskazuje, która usługa w systemie Linux odpowiada usłudze znanej z Windows Server
    - otwiera udział serwera Linux ze stacji Windows

    **Ocena dostateczna (3)** — *wymagania podstawowe*

    - rozróżnia sieciowe systemy operacyjne obu rodzin i zestawia nazwy ich ról oraz usług
    - przyłącza stację roboczą do domeny
    - konfiguruje serwer tak, aby stacje Windows widziały jego udziały i drukarkę

    **Ocena dobra (4)** — *wymagania rozszerzające*

    - publikuje udostępnione zasoby sieciowe, korzystając z usług katalogowych
    ...
    **Ocena bardzo dobra (5)** — *wymagania dopełniające*
    ...
    - dobiera rodzinę systemu do zadanego przeznaczenia serwera i uzasadnia wybór kosztami oraz wymaganiami
    ...
    **Ocena celująca (6)** — *wymagania wykraczające*
    ...
    - buduje i dokumentuje środowisko, w którym serwer Linux obsługuje stacje Windows i Linux
    - rozwiązuje zadania egzaminacyjne INF.07 wymagające pracy w obu rodzinach systemów

??? abstract "Dział XI. Przygotowanie do egzaminu zawodowego INF.07 — 3 godziny"

    **Ocena dopuszczająca (2)** — *wymagania konieczne*

    - rozpoznaje polecenia w treści zadania egzaminacyjnego i wykonuje część z nich z pomocą nauczyciela

    **Ocena dostateczna (3)** — *wymagania podstawowe*

    - wykonuje typowe zadanie egzaminacyjne w zakresie wdrożenia i konfiguracji usługi

    **Ocena dobra (4)** — *wymagania rozszerzające*

    - wykonuje zadanie egzaminacyjne w wyznaczonym czasie i sporządza wymaganą dokumentację

    **Ocena bardzo dobra (5)** — *wymagania dopełniające*

    - wykonuje zadanie egzaminacyjne bezbłędnie, weryfikując działanie skonfigurowanych usług
    - wskazuje w treści zadania miejsca, w których najczęściej traci się punkty

    **Ocena celująca (6)** — *wymagania wykraczające*

    - rozwiązuje zadania z arkuszy z lat ubiegłych powyżej progu zdawalności i omawia rozwiązania z klasą
