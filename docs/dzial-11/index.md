...
**3 godziny · 1 temat · klasa 3TT · kwalifikacja INF.07**
...
??? abstract "Rozwiń wymagania — dział XI"
...
<div class="kp-podsumowanie" data-karta="dzial-11"></div>

<span id="karta" class="kp-kotwica"></span>

??? karta "Rozwiń kartę pracy działu XI"
    ...
    !!! warning "Chcesz dokończyć w domu — zapisz postęp do pliku"
        ...
        Dostaniesz plik `postep_asso-dzial-11.json` — przenieś go
    ...
    <div class="karta-pracy" data-karta="dzial-11"></div>
